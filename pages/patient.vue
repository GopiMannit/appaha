              ...
              <form action="#" method="post">
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-control border-top-0 border-right-0 border-left-0"
                        name="followUpDate" id="followUpDate" placeholder="Follow Up Date" @focus="switchToFollowUpDateInput"
                        v-model="data.followUpDate" @input="validateDate('followUpDate')" :min="getMinDate()">
